...
def run() -> object:
    ...
    suite.check_equal("no hands means no primary hand", empty_selection.primary, None)
    ...
    suite.check_equal("largest bounding box becomes primary first", first_selection.primary, left_large)
    suite.check_equal("left hand reference is preserved", first_selection.left, left_large)
    suite.check_equal("right hand reference is preserved", first_selection.right, right_small)
    suite.check_equal("secondary hand is filled", first_selection.secondary, right_small)
    ...
    suite.check_equal("lost hand beyond grace period clears primary memory", selector._last_primary_center_px, None)
