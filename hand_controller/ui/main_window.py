...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self) -> None:
        ...
        subtitle = QLabel(self.ui_mode_label)
        ...
        self.start_button = QPushButton(self.start_button_label)
        ...
        summary_layout.addWidget(QLabel(
            "temporary lang na main window ini, \n" 
            "duman na kita madepende sa ui design ni wis\n" 
            "bago ako magasikaso kang ui, dapat okay na saindo ining improvements"
        ))
    ...
    def _set_status(self, text: str, *, running: bool) -> None:
        if self.status_label is not None:
            ...
            self.status_label.setStyleSheet("color: #55ff55;" if running else "color: #dddddd;")
        if self.start_button is not None:
            if running:
                self.start_button.setText(self.stop_button_label)
